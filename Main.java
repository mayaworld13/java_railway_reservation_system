...
class ReservationSystem {
    ...
    public ReservationSystem() {
        ...
        // Add sample trains
        trains.add(new Train("Vandey Bharat express", "Gwalior", "Delhi", "09:05", 50, 22182));
        trains.add(new Train("Khajuraho express", "Gwalior", "Jaipur", "15:00", 50, 12427));
        trains.add(new Train("Mahakaushal express", "Gwalior", "Satna", "17:46", 50, 12189));
    }
